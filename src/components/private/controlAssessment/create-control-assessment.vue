...
export default {
  ...
  try {
    ...
    async fetchInformationAsset() {
      ...
      console.log(informationAsset)
      // Update the options for the 'riskCategory' field
      const informationAssetMainCategory = this.formFields.find(
        (field) => field.model === "assetMainCategory"
      );

      console.log("formFields", this.formFields)
      console.log("informationAssetMainCategory", informationAssetMainCategory)
      if (informationAssetMainCategory) {
        informationAssetMainCategory.options = informationAsset.filter(item => item.type == "Main Category");
        console.log("informationasset main", informationAssetMainCategory)
      }

      const informationAssetSubCategory = this.formFields.find(
        (field) => field.model === "assetSubCategory"
      );  

      if (informationAssetSubCategory) {
        informationAssetSubCategory.options = informationAsset.filter(item => item.type == "Sub Category");
        console.log("informationasset sub", informationAssetSubCategory)
      }
    },
