<template>
  <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
    <div class="text-center mb-6">
      <img src="@/assets/logo.jpg" alt="Assessment Platform Logo" class="h-24 mx-auto" />
    </div>
    <h2 class="text-4xl font-bold text-center mb-6">Welcome to the Assessment Dashboard</h2>
    <p class="text-lg text-gray-700 text-center mb-8">
      Track your assessments, view results, and manage deadlines all in one place.
    </p>
    ...
    <div class="bg-white p-4 rounded-lg border border-gray-200 mb-6 shadow">
      ...
      <ul class="list-decimal list-inside text-gray-700">
        <li>Assessment guidelines have been updated; please check the resources section.</li>
      </ul>
    </div>
