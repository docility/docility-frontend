...
<script>
import CompanyList from "./control-domain-list.vue";
import CompanyDetailsModal from "./control-domain-details.vue";
import AddCompanyModal from "./create-control-domain.vue";
  ...
  methods: {
    ...
    async addNewCompany(newCompany) {
      ...
      if (newCompany?.documentId) {
        ...
        http.put(`api/control-domains/${id}`, {
          data: newCompany,
        }).then((res) => {
          console.log(res);
          this.companyListKey++;
        ...
        await http.post("api/control-domains", { data: newCompany }).then((res) => {
          console.log(res);
          this.companyListKey++;
        });   
      }
