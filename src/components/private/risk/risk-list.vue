  ...
  data() {
    return {
      headers: {
        ...
        treatmentPlanFile: "Treatment Plan File",
        treatmentApprovalEvidenceFile: "Treatment Approval Evidence File",
        residualRiskApprovalFile: "Residual Risk Approval File",
      },
      suppliers: [],
      searchQuery: "",
