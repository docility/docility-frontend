        ...
        <ul class="mt-6 space-y-2">
          ...
          <li>
            <router-link
              ...
              :class="[
                'block px-4 py-2 rounded',
                isActive('/dashboard/risk-assessment')
                  ? 'active-button-style'
                  : 'button-style',
              ]"
            >
          ...
          <li>
            <router-link
              ...
              :class="[
                'block px-4 py-2 rounded',
                isActive('/dashboard/customer-management')
                  ? 'active-button-style'
                  : 'button-style',
              ]"
            >
          ...
          <li>
            <router-link
              ...
              :class="[
                'block px-4 py-2 rounded',
                isActive('/dashboard/company-management')
                  ? 'active-button-style'
                  : 'button-style',
              ]"
            >
          ...
          <li>
            <router-link
              ...
              :class="[
                'block px-4 py-2 rounded',
                isActive('/dashboard/questionnaire-management')
                  ? 'active-button-style'
                  : 'button-style',
              ]"
            >
